puts "Please type your birthday in MMDDYYYY format!"

yourBirthday = gets

number = yourBirthday[0].to_i + yourBirthday[1].to_i + yourBirthday[2].to_i + yourBirthday[3].to_i + yourBirthday[4].to_i + yourBirthday[5].to_i + yourBirthday[6].to_i + yourBirthday[7].to_i 
...
when 3
	puts "Your numerology number is 3. Number Three is a sociable, friendly, and outgoing vibration. Kind, positive, and optimistic, Threes enjoy life and have a good sense of humor. Ruled by Jupiter."
...
when 8
	puts "Your numerological number is 8. This is the manager. Number Eight is a strong, successful, and material vibration. Ruled by Saturn."

when 9
	puts "Your numerological number is 9. This is the teacher. Number Nine is a tolerant, somewhat impractical, and sympathetic vibration. Ruled by Mars."
